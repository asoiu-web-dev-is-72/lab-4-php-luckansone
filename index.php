<?php
    if(isset($_POST["done"]))
    {
         ...
         else if($m==""||!is_numeric($m)||$m<=1||$m>=100)
        {
            ...
            $error_m="<i>Введіть правильну к-ість рядків і стовпчиків.</i>";
            $error="true";
...
<html>
    ...
    <body>
        <p><i>виконала Кравчук Олена ІС-72</i></p>
        <h1><b1><center><i>Лабораторна робота №4</i></center></b1></h1>
        <center>
            <form  action="" name="form" method="post">
                <label>Введіть к-ість рядків і стовпчиків: </label><br/>
 ...
 <?php
    if(!$error)
        {
            $table1="<center><p><i>1.Таблиця</i></p></center>";
            echo $table1;
            echo '<table>';
            $iter=0;
            for($tr=0;$tr<$m;$tr++)
        ...
        echo '</table>';
        $table2="<center><p><i>2.Таблиця</i></p></center>";
        $iter=1;
        echo $table2;
        echo '<table>';
            for($tr=0;$tr<$m;$tr++)
        ...
        echo '</table>';
        $table3="<center><p><i>3.Таблиця</i></p></center>";
        echo $table3;
        $iter=1;
        echo "<table>";
        for($i=0;$i<$m;$i++)
        ...
        $table4="<center><p><i>4.Таблиця</i></p></center>";
            echo $table4;
            $column_fill=[3,0,0];
			$counter=1;
			$remainder = $m >= 3 ? 3: $n;
